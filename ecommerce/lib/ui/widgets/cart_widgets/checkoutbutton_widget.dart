...
Widget CheckoutWidget(BuildContext context) {
  ...
  return Consumer2<CartProvider, Notificationsprovider>(
    ...
    return TextButton(
      style: ButtonStyle(
          fixedSize: MaterialStateProperty.all(Size(double.infinity, 68))),
      onPressed: () async {
              ...
              child: AlertDialog(
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    Text(preferences.getString("email")!, style: smallStyle),
                    SizedBox(
                      height: 5,
                    ),
                    Text(
      ...
      child: Container(
        ...
        child: Center(
          child: Text('Proceed to checkout'.toUpperCase(), style: boldWhite),
        ),
      ),
    );
  });
