...
import 'package:myfirst_app/screens/user_screens/cartscreen.dart';
import 'package:provider/provider.dart';

import '../../../localization/localization.dart';
import '../../../providers/product_provider.dart';
import '../../user_screens/favouriteScreen.dart';
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.fromLTRB(0, 50, 0, 0),
                    ...
                    child:  Consumer<FavouritesProvider>(builder: (context, data, child) {return InkWell(
                      onTap: () {
                   Navigator.of(context).push(MaterialPageRoute(
                      builder: (BuildContext context) =>
                          FavouritePge(favouritelistProduct: data.favouritelistProduct)));},
                      child: Icon(
