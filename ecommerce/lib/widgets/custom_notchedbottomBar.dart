  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      child: SizedBox.fromSize(
        ...
        child: Opacity(
            opacity: kPi * 2* (scrollPosition % 1) == 0 ? 1 : 0, child: Padding(
...
class MyAnimatedNotchBottomBar extends StatefulWidget {
  ...
  @override
  _MyAnimatedNotchBottomBarState createState() => _MyAnimatedNotchBottomBarState();
}
                  ...
                  child: Opacity(
                    ...
                    child: CustomPaint(
                      ...
                      painter: BottomBarPainter(
                          ...
                          color: Colors.grey.shade200,//widget.color,
                          showShadow: widget.showShadow,
                          notchColor: Colors.black,//widget.notchColor
                      ),
                    ),
                  ),
                ),
